...
export default ChooseStats = ({ navigation }) => {
  return (
    ...
    <View style={{ flex: 1 }}>
      <View style={styles.containerHeader}>
        <View style={styles.signIn}>
          ...
          <TouchableOpacity>
            <Text style={styles.textSignIn}>Thống kê</Text>
          </TouchableOpacity>
        </View>
      </View>
    ...
    <View>
      ...
      >
        <TouchableOpacity
          ...
          onPress={() => {
            navigation.navigate("ProductListStats", {
              storeId: storeId,
            });
          }}
        >
          ...
          >
            <Image
              source={require("../../images/stats1.png")}
        ...
        <TouchableOpacity
          style={styles.btnItem1}
          onPress={() => {
            navigation.navigate("CategoryListStats", {
              storeId: storeId,
            });
          }}
        >
          ...
          >
            <Image
              source={require("../../images/stats2.png")}
