...
export default ListConfirmProduct = ({ navigation }) => {
...
const ContentComponent = ({ navigation }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(endpoints.get_product_statusFalse);
                ...
                >
                  ...
                  >
                    ...
                    <Text style={styles.nameProduct1}>
                      Sản phẩm cần xác nhận: {store.product_false_count}
                    </Text>
                  </View>
                  <View
                    style={{
