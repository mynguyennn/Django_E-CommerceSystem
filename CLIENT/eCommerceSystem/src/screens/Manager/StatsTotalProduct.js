...
export default StatsTotalProduct = ({ navigation }) => {
  return (
      ...
      try {
        if (selectedYear) {
          ...
          const newBarDataMonth = months.map((month, index) => {
            ...
            return {
              value: monthData.total_products,
              label: month,
      ...
      try {
        if (selectedYear) {
          ...
          const newBarDataQuarter = quarterlyStats.map((quarterData, index) => {
            return {
              value: quarterData.total_products || 0,
      ...
      >
        ...
        <View style={styles.customBarChartStyle}>
          <View style={styles.tableColumn}>
            ...
            >
              Tổng sản phẩm kinh doanh năm [{selectedYear}]:
            </Text>
            <Text
              style={{
                color: "white",
            ...
            >
              {productStatsMonth.total_products_all_months} sp
            </Text>
          </View>
          {/*month*/}
          <Text
            ...
            >
              {productStatsQuarter.map((quarterData, index) => (
                ...
                >
                  ...
                  <Text style={{ fontWeight: "500" }}>
                    {quarterData.total_products || 0} sp
                  </Text>
                </View>
              ))}
            </View>
